...
class TimelineConst
{
	constructor()
	{
		this.majorEvents = [
			...
			{ name: '沖縄自駕遊',     description: '', start: '2016/07/05', end: '2016/07/10' },
		...
		this.basePeriod = [
			...
			{ name: '當兵',           description: '', start: '1996/07/16', end: '1998/06/11' },
			{ name: '晨軒電腦',       description: '', start: '1998/10/01', end: '1999/06/31' },
