...
class TimelineConst
{
	constructor()
	{
		this.majorEvents = [
			...
			{ name: '結婚',           start: '2006/02/15', end: '2006/02/15' },
			// ---
			{ name: '瑞士夢幻之旅',     start: '2002/08/24', end: '2002/09/02' },
			//{ name: '北京香港順路玩',   start: '..../12/14', end: '..../12/28' },
			//{ name: '北京出差人',   start: '..../12/14', end: '..../12/28' },
			{ name: '北海道跟團跑',     start: '2011/03/01', end: '2011/03/05' },
			{ name: '大阪健健行 Part1', start: '2013/03/14', end: '2013/03/17' },
			{ name: '大阪健健行 Part2', start: '2014/04/14', end: '2014/04/20' },
